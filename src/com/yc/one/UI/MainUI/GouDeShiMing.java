...
public class GouDeShiMing extends Composite {
	 ...
	 * @param style
	 */
	public GouDeShiMing(Composite parent, int style) {
		super(parent, style);
		Label label = new Label(this, SWT.NONE);
		label.setImage(SWTResourceManager.getImage(GouDeShiMing.class, "/image/15.jpg"));
		label.setBounds(34, 34, 144, 185);
		
		Label label_1 = new Label(this, SWT.NONE);
		label_1.setBounds(200, 50, 95, 20);
		label_1.setText("一条狗的使命");
